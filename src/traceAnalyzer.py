...
def main():
    ...
    #################################################################
    if RETX_DEBUG:
        print "Before invalid IP elimination, # of packets is %d" % (len(QCATEntries))

    QCATEntries = util.eliminateInvalidIPPackets(QCATEntries)

    if RETX_DEBUG:
        print "After invalid IP elimination, # of packets is %d" % (len(QCATEntries))
    
    QCATEntries = util.groupSegmentedIPPackets(QCATEntries)

    if RETX_DEBUG:
        print "After group IP packets, # of packets is %d" % (len(QCATEntries))
    ...
    util.groupSegmentedIPPackets(QCATEntries)
