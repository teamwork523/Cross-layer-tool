...
plot  "tmp_FACH_to_DCH_start.txt" using 1:(4) with points pt 1 lc rgb 'blue' title "FACH_to_DCH Begin", \
      "tmp_FACH_to_DCH_end.txt" using 1:(4) with points pt 2 lc rgb 'red' title "FACH_to_DCH End", \
      "tmp_RLC_begin.txt" using 1:(5) with points pt 9 lc rgb 'orange' title "RLC PDUs"      
