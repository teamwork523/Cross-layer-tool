...
Tools/plot/cdfConverterWithFilter.py $data_col 1 n 2 Normal DCH FACH+DCH Inaccurate < $tmobile_file > tmobile_cdf

# merge two cdf file
Tools/common/mergeTwoFile.py att_cdf tmobile_cdf 2 3 4 5 > tmp.txt
...
plot "tmp.txt" u 2:1 w linespoints lt 8 pi -15 ps 1 pt 3 lc rgb "orange" title "AT&T Normal", \
     "" u 3:1 w linespoints lt 1 pi -15 ps 1 pt 2 title "AT&T FACH_to_DCH", \
     "" u 4:1 w linespoints lt 9 pi -15 ps 1 pt 5 lc rgb "green" title "T-Mobile Normal", \
     "" u 5:1 w linespoints lt 7 pi -15 ps 1 pt 4 title "T-Mobile FACH_to_DCH", \
     "" u 6:1 w linespoints lt 5 pi -15 ps 1 pt 7 title "T-Mobile PCH_to_DCH", \
     "" u 7:1 w linespoints lt 11 pi -15 ps 1 lc rgb "pink" pt 6 title "T-Mobile Inaccurate RRC state"
