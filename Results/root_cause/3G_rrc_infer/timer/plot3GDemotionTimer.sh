...
../Tools/plot/cdfConverterWithFilter.py 2 1 n 1 FACH_to_PCH_with_phy_reconfig DCH_to_FACH < $tmobile_file > tmobile_cdf
...
plot "tmp.txt" u 2:1 w linespoints lt 8 pi -30 ps 1 pt 3 lc rgb "orange" title "$legend"
