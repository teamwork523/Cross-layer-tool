...
plot "TCP/$file\_TCP.txt" using 1:(0):(0):5 with vectors arrowstyle 1 title "TCP Packets", \
     "RLC\/$file\_RLC.txt" using 1:(0):(0):5 with vectors arrowstyle 2 title "RLC PDUs"
EOF
