...
set label "DCH" at 1.25,0.45 center font "Arial, 18"
set label "FACH" at 4,0.45 center font "Arial, 18"
set label "PCH" at 6.75,0.45 center font "Arial, 18"
...
plot "$file.txt" using (\$1):(\$4):(\$4-\$5):(\$4+\$5) with errorbars title "Galaxy S3" lt 3 lc rgb "red" pt 9 ps 1.5, \
     ...
     "dotedline.txt" using 1:(0):(0):2 with vectors arrowstyle 1 notitle
